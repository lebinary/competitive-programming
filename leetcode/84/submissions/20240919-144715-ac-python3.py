...
# Memory: 33.7 MB (beats 30.6%)
# Submitted: 2024-09-19 14:47:15 UTC
# URL: https://leetcode.com/submissions/detail/1395516000/

class Solution:
    def largestRectangleArea(self, heights: List[int]) -> int:
        # intuition: 
        # try to extend bar as far right as possible
        # if cannot extend anymore, calculate the are and pop
