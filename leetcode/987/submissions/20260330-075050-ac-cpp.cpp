 ...
 * Memory: 16.5 MB (beats 29.7%)
 * Submitted: 2026-03-30 07:50:51 UTC
 * URL: https://leetcode.com/submissions/detail/1963599368/
 */
    ...
    vector<vector<int>> verticalTraversal(TreeNode* root) {
        ...
        for(auto& [col, rowMap] : sortedMap) {
            for(auto& [row, vec] : rowMap) {
                ...
                res[i].insert(res[i].end(), vec.begin(), vec.end());
            }
            i++;
        }
        return res;
