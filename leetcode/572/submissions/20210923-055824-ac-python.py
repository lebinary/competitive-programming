...
# Difficulty: Easy
# Status: Accepted
# Runtime: 300 ms (beats 5.1%)
# Memory: 14.4 MB (beats 9.6%)
# Submitted: 2021-09-23 05:58:24 UTC
# URL: https://leetcode.com/submissions/detail/559583392/
...
class Solution(object):
    def isSubtree(self, root, subRoot):
        ...
        # Find all the roots of subTree in Tree
        subTreeRoots = self.findNode(root, subRoot.val, [])
        
        if len(subTreeRoots) > 0:
            # Compare all the roots in tree and subtree
